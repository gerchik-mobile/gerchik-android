...
internal class DiffUtilCallbackDelegatesManager<T>() : DiffUtilCallbackDelegate<T>() {
    ...
    private fun <R> onDelegatesEquals(oldItem: T, newItem: T, defValue: R, block: DiffUtil.ItemCallback<T>.() -> R): R {
