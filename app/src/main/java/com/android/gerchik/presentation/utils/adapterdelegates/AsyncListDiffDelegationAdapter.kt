...
import com.android.gerchik.presentation.extensions.observeNotNull
import com.hannesdorfmann.adapterdelegates4.AdapterDelegatesManager

internal class AsyncListDiffDelegationAdapter<T>(
    ...
    fun <I : T> subscribe(
        ...
        liveDate.observeNotNull(lifecycleOwner, observer)
        return observer
    }
}